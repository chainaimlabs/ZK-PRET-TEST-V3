...
import {getBPIVerificationFileTestWithSign} from './BusinessProcessIntegrityVerificationFileTestWithSignUtils.js';
...
// export async function getBPIVerificationFileTestWithSign(expectedPath: string, actualPath: string) {
//    /*
//    const outputData = {
...
async function main() {
   ...
   const proof = await getBPIVerificationFileTestWithSign(businessProcessType,expectedPath, actualPath);
