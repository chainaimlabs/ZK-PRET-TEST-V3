...
// Command used: '\S.*\S' '--functionName' 'fun0' '--filePath' './src/regexCircuits.ts'
...
// Command used: '[A-Z]{2}' '--functionName' 'fun1' '--filePath' './src/regexCircuits.ts'
...
// Command used: '\S+' '--functionName' 'fun2' '--filePath' './src/regexCircuits.ts'
